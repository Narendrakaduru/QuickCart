  ...
  return (
    <div className="container mx-auto px-4 py-20 flex items-center justify-center">
      <div className="bg-white w-full max-w-md p-8 md:p-10 shadow-2xl shadow-gray-200 rounded-[2.5rem] border border-gray-100">
        ...
        <p className="text-gray-500 text-center mb-10 text-sm font-medium">Join QuickCart for a premium shopping experience</p>
        ...
        <form onSubmit={onSubmit} className="space-y-5">
          ...
          <div className="space-y-2">
            ...
            />
            {isNoUser && (
              <p className="text-red-500 text-[10px] mt-1 uppercase font-bold tracking-tight pl-1">{message}</p>
            )}
          </div>
          <div className="space-y-2">
            <label
